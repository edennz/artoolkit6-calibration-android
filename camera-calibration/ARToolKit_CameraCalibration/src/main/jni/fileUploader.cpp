...
FILE_UPLOAD_HANDLE_t *fileUploaderInit(const char queueDirPath[6], const char formExtension[7],
    ...
    ARLOGd("entered fileUploaderInit queueDirPath: %s, formExtension: %s, formPostURL: %s, "
                   "statusHideAfterSecs: %f",queueDirPath,formExtension,formPostURL,statusHideAfterSecs);
