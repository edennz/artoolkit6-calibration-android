...
typedef enum {
    ...
    AR_VIDEO_MODULE_V4L                = 1,
    AR_VIDEO_MODULE_DV                 = 2,
    AR_VIDEO_MODULE_1394CAM            = 3,
    AR_VIDEO_MODULE_RESERVED1          = 4,
    AR_VIDEO_MODULE_RESERVED2          = 5,
    AR_VIDEO_MODULE_RESERVED3          = 6,
    AR_VIDEO_MODULE_RESERVED4          = 7,
    AR_VIDEO_MODULE_RESERVED5          = 8,
    AR_VIDEO_MODULE_RESERVED6          = 9,
    AR_VIDEO_MODULE_RESERVED7          = 10,
    AR_VIDEO_MODULE_GSTREAMER          = 11,
    AR_VIDEO_MODULE_AVFOUNDATION       = 12,
    AR_VIDEO_MODULE_RESERVED8          = 13,
