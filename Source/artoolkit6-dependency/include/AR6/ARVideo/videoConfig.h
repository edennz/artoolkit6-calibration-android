...
#if AR6_ARVIDEO_INPUT_1394CAM_DEFAULT_PIXEL_FORMAT == AR_PIXEL_FORMAT_MONO
#if defined(AR6_ARVIDEO_INPUT_1394CAM_USE_FLEA_XGA)
...
#endif
#else
#if defined(AR6_ARVIDEO_INPUT_1394CAM_USE_DRAGONFLY)
#define   AR_VIDEO_1394_DEFAULT_MODE                   AR_VIDEO_1394_MODE_640x480_MONO_COLOR
#elif defined(AR6_ARVIDEO_INPUT_1394CAM_USE_DF_EXPRESS)
#define   AR_VIDEO_1394_DEFAULT_MODE                   AR_VIDEO_1394_MODE_640x480_MONO_COLOR2
#elif defined(AR6_ARVIDEO_INPUT_1394CAM_USE_FLEA)
#define   AR_VIDEO_1394_DEFAULT_MODE                   AR_VIDEO_1394_MODE_640x480_MONO_COLOR2
#elif defined(AR6_ARVIDEO_INPUT_1394CAM_USE_FLEA_XGA)
#define   AR_VIDEO_1394_DEFAULT_MODE                   AR_VIDEO_1394_MODE_1024x768_MONO_COLOR
#elif defined(AR6_ARVIDEO_INPUT_1394CAM_USE_DFK21AF04)
