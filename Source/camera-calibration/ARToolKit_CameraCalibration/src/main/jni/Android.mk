...
ARTOOLKIT_DIR := $(MY_LOCAL_PATH)/../../../../../artoolkit6-dependency
CURL_DIR := $(MY_LOCAL_PATH)/../../../../../curl-dependency
ARTOOLKIT_LIBDIR := $(call host-path,$(ARTOOLKIT_DIR)/$(TARGET_ARCH_ABI))
...
CURL_LIBDIR := $(call host-path,$(CURL_DIR)/$(TARGET_ARCH_ABI))
