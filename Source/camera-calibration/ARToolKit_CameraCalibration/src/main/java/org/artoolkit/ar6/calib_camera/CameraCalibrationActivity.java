...
//    public static final int PRINT_POS = 4;
    ...
    public static native boolean nativeInitialize(Context ctx,String calibrationServerURL, int cameraId, boolean isFronFacing);
    ...
    public void onResume() {
        ...
        if (!CameraCalibrationActivity.nativeInitialize(this,cameraCalibrationServer,cameraId,frontFacing)) {
